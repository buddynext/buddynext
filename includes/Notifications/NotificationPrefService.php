...
class NotificationPrefService {
	...
	public function set_pref( int $user_id, string $type, array $data ): void {
		...
		// partner-registered types still validate. 'digest' (the digest master
		// switch the unsubscribe link writes) is a catalogue entry too, so it
		// passes here without a special-case bypass.
