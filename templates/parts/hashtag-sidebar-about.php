...
<div class="<?php echo esc_attr( $bn_class ); ?>">
	 ...
	 *
	 * The hashtag hero already carries one, for the same tag, wired to the same
	 * action — two controls for one piece of state, a few hundred pixels apart.
	 * This card is a summary of the tag; following it is an action, and the page
	 * only needs to offer that once.
	 *
	 * The duplicate was also the broken one: rendered outside any Interactivity
	 * island and with no restNonce in its context, so it could never have worked.
	 * Deleting it removes the defect and the duplication together, rather than
	 * repairing a control that should not have been here.
	 */
	?>
</div>
<?php
