...
> **This file is the pre-1.0 beta archive and is no longer maintained.**
>
> `readme.txt` is the changelog of record — it carries every release from
> 0.6.0-beta1 through the current version, in the WordPress-standard
> action-prefix format. Add new entries there, not here.
>
> Kept because the 0.2.0 - 0.4.0-beta1 entries below predate `readme.txt` and
> exist nowhere else. The former "Unreleased" section was removed on 2026-07-21:
> that work shipped in 1.0.0 and is summarised in the `readme.txt` 1.0.0 entry.
