...
- [Member Types](05-member-types.md) - the categories the directory filters by
- [Following Members](06-following.md) - the follow action on each member card
- [Connecting With Members](07-connections.md) - the connect action on each member card
- [Custom Profile Fields](02-profile-fields.md) - which fields directory search can match
