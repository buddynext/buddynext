...
Categories are managed in the admin under BuddyNext > Spaces > Directory, in the Categories subtab. From there you create, edit, reorder, and delete categories. Each category has these fields:
