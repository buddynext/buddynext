...
- "Show me everyone on the Premium plan" - by membership plan.
...
The filters read from your real data. The plan list shows the plans you actually offer, the space list shows spaces the searcher already belongs to, and the label list shows the labels you created. There are no empty or irrelevant options to wade through.
