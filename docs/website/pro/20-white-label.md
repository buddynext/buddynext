...
![The Appearance branding admin tab where you set the brand name, logo, accent hue, fonts, and custom CSS](../images/admin-appearance.webp)

![The community front-end showing your applied branding and logo](../images/community-activity-feed.webp)
...
![The White-label settings with media-library logo pickers](../images/admin-white-label.webp)
