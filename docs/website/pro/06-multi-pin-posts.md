...
On your own profile, open the options menu on one of your posts (the menu on the post card) and choose **Pin**. The post moves to the top of your profile feed and stays there above the regular, time-ordered posts. The menu label then switches to **Unpin** so you can reverse it.

### Unpin a post

Open the same menu on a pinned post and choose **Unpin**. The post drops back into the normal feed in its usual chronological place and the top-of-profile slot it held is freed up for another post.

### Where pinned posts show

Pinned posts sit at the top of the member's profile feed. Each pinned post is marked as pinned on its card so visitors can see it is being held there on purpose rather than just being recent.
